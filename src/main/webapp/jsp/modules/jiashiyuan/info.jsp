            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">驾驶员登记</li>
                    </ol>
                </div>
            </div>
        </div>
                            ...
                            <!-- 本表所有字段 -->
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="cardNumber" name="cardNumber" class="form-control"
                                               v-model="ruleForm.cardNumber" readonly>
                                    </div>
                                ...
                                <div class="form-group col-md-6">
                                    <label>照片</label>
                                    <img id="jiashiyuanPhotoImg" width="100" height="100">
                                </div>
    ...
    var vm = new Vue({
        ...
        beforeCreate: function () {
            ...
            if (id != null && id != "" && id != "null") {
                $.ajax({
                    type: "GET",
                    url: baseUrl + "jiashiyuan/info/" + id,
