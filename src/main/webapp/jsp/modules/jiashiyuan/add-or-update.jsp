            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">编辑驾驶员</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="widget-area-2 lochana-box-shadow">
                        <h3 class="widget-title">驾驶员信息</h3>
                            ...
                            <!-- 当前表的字段 -->
                                ...
                                <div class="form-group col-md-6">
                                   ...
                                   <div class="form-group col-md-6">
                                       ...
                                       <input name="file" type="file" id="jiashiyuanPhotoupload"
                                              class="form-control-file">
                                       <input name="jiashiyuanPhoto" id="jiashiyuanPhoto-input" type="hidden">
                                   </div>
                                <div class="form-group col-md-6">
                                    <label>年龄</label>
...
<script>
    ...
    function upload() {
        ...
        $('#jiashiyuanPhotoupload').fileupload({
            url: baseUrl + 'file/upload',
            headers: {token: window.sessionStorage.getItem("token")},
            dataType: 'json',
            done: function (e, data) {
                var photoUrl= baseUrl + 'file/download?fileName=' + data.result.file;
                document.getElementById('jiashiyuanPhotoImg').setAttribute('src',photoUrl);
                document.getElementById('jiashiyuanPhoto-input').setAttribute('value',photoUrl);
            }
        });
    ...
    function submit() {
        if (validform() == true && compare() == true) {
            ...
            httpJson("jiashiyuan/" + urlParam, "POST", data, (res) => {
                if(res.code == 0){
                    window.sessionStorage.removeItem('addjiashiyuan');
    ...
    // 获取当前详情
    function getDetails() {
        var addjiashiyuan = window.sessionStorage.getItem("addjiashiyuan");
        if (addjiashiyuan != null && addjiashiyuan != "" && addjiashiyuan != "null") {
            window.sessionStorage.removeItem('addjiashiyuan');
            //注册表单验证
            $(validform());
            $('#submitBtn').text('新增');
            ...
            window.sessionStorage.removeItem('updateId');
            http("jiashiyuan/info/" + updateId, "GET", {}, (res) => {
                if(res.code == 0)
                {
                    ruleForm = res.data
                    // 是/否下拉框回显
