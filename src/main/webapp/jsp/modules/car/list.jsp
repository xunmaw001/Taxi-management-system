                    ...
                    <div class="widget-area-2 lochana-box-shadow">
                        ...
                        <div class="table-responsive mb-3">
                            <div class="col-sm-12">
                                        ...
                                        <label>
                                            车牌号
                                            <input type="text" id="carNumberSearch" style="width: 140px;" class="form-control form-control-sm"
                                                   placeholder="车牌号" aria-controls="tableId">
                                        </label>
                                 
                                        <label>
                                            车架号
                                            <input type="text" id="chejiaNumberSearch" style="width: 140px;" class="form-control form-control-sm"
                                            ...
                                            <label>
                                                驾驶证号
                                                <input type="text" id="cardNumberSearch"  style="width: 120px;" class="form-control form-control-sm"
