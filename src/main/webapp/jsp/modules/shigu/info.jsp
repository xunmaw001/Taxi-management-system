            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">事故登记</li>
                    </ol>
                </div>
            </div>
        </div>
                    ...
                    <div class="widget-area-2 lochana-box-shadow">
                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 本表所有字段 -->
                                ...
                                <div class="form-group col-md-6">
                                    <label>事故类型</label>
                                    <input id="shiguValue" name="shiguValue" class="form-control"
                                           v-model="ruleForm.shiguValue" readonly>
                                </div>

                                <div class="form-group col-md-6">
                                    <label>事故照片</label>
                                    <img id="shiguPhotoImg" width="100" height="100">
                                </div>

                                <div class="form-group col-md-6">
                                    <label>是否处理</label>
                                    <input id="shiguchuliValue" name="shiguchuliValue" class="form-control"
                                           v-model="ruleForm.shiguchuliValue" readonly>
                                </div>
        ...
        if (ruleForm.shiguContent != null && ruleForm.shiguContent != 'null' && ruleForm.shiguContent != '') {
            var shiguContentUeditor = UE.getEditor('shiguContentEditor');
                shiguContentUeditor.ready(function () {
                    ...
                    shiguContentUeditor.setDisabled('fullscreen');
            });
        }
    }
