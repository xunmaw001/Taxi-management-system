            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">年审登记</li>
                    </ol>
                </div>
            </div>
        </div>
                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 级联表所有字段 -->
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input id="jiashiyuanId" name="jiashiyuanId" class="form-control"
                                                   v-model="ruleForm.jiashiyuanId" readonly>
                                        </div>
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input id="carNumber" name="carNumber" class="form-control"
                                                   v-model="ruleForm.carNumber" readonly>
                                        </div>
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input id="chejiaNumber" name="chejiaNumber" class="form-control"
                                                   v-model="ruleForm.chejiaNumber" readonly>
                                        </div>
                            ...
                            <!-- 本表所有字段 -->
                                ...
                                <input id="carId" name="carId" v-model="ruleForm.carId" readonly type="hidden">
                                    ...
                                    <div class="form-group col-md-6">
                                        <label>年审日期</label>
                                        <input id="nianshenTime" name="nianshenTime" class="form-control"
                                               v-model="ruleForm.nianshenTime" readonly>
                                    </div>


                                <div class="form-group col-md-6">
                                    <label>年审结果</label>
                                    <input id="nianshenValue" name="nianshenValue" class="form-control"
                                           v-model="ruleForm.nianshenValue" readonly>
                                </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="nianshenNumber" name="nianshenNumber" class="form-control"
                                               v-model="ruleForm.nianshenNumber" readonly>
                                    </div>

                                <div class="form-group col-md-6">
                                    <label>年审照片</label>
                                    <img id="nianshenPhotoImg" width="100" height="100">
                                </div>
        ...
        if (ruleForm.carContent != null && ruleForm.carContent != 'null' && ruleForm.carContent != '') {
            var carContentUeditor = UE.getEditor('carContentEditor');
                carContentUeditor.ready(function () {
                    ...
                    carContentUeditor.setDisabled('fullscreen');
            });
        }
        if (ruleForm.nianshenContent != null && ruleForm.nianshenContent != 'null' && ruleForm.nianshenContent != '') {
            var nianshenContentUeditor = UE.getEditor('nianshenContentEditor');
                nianshenContentUeditor.ready(function () {
                    ...
                    nianshenContentUeditor.setDisabled('fullscreen');
            });
        }
    }
